...
public class HomeView implements Initializable{
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		try{
			...
			//Apro di default una lista di attivitÔøΩ che hanno a che fare con Boxe e Tennis.
				...
				//tutto ci√≤ che √® stato scritto.
					...
					send.setOnAction(new EventHandler<ActionEvent>() {
						@Override public void handle(ActionEvent e) {
							...
							//TODO Nel metodo chiamato non conviene passare solo l'attivit‡ selezionata e da lÏ estrapolare gli altri parametri essendo tutti derivati? P.S:ho gi‡ levato uno dei parametri
